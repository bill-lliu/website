          ...
          <Cell col={6}>
            ...
            <div className="contact-list">
              <List>
                <ListItem>
                  <ListItemContent>
                    <a href="mailto:siyi.liu@uwaterloo.ca">
                ...
                <ListItem>
                  <ListItemContent>
                    <a href="mailto:billliusiyi@gmail.com">
                      <i class="fas fa-envelope-square"></i>
                    </a>
                  </ListItemContent>
                  <ListItemContent>
                ...
                <ListItem>
                  <ListItemContent>
                    <a href="tel:+14158289304">
                      <i class="fas fa-phone-square-alt"></i>
                    </a>
                  </ListItemContent>
                  <ListItemContent>
                    <a href="tel:+14158289304">+1 (415)-828-9304</a>
                  </ListItemContent>
                </ListItem>
                <ListItem>
                  <ListItemContent>
