          ...
          <div className="portfolio-contents">
            ...
            <Card shadow={5} className="card">
              <CardText style={{ textAlign: "center", marginTop: "1.5em" }}>
                ...
                This section of my website is still currently under
                construction! Please visit my LinkedIn, Devpost, or GitHub to
                find my past projects, or simply shoot me a message!
              </CardText>
    ...
    return (
      <div className="category-tabs">
        <Tabs
          ...
          ripple
        >
          <Tab className="tab" style={{ color: "white" }}>
            Portfolio!
          </Tab>
          {/*0*/}
          <Tab className="tab" style={{ color: "white" }}>
